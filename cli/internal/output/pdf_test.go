// Package output_test exercises the PDF writer through the public output API.
// This file is intentionally in the "output_test" (external) package so it can
// import both "output" and "output/pdf" without creating an import cycle
// (output/pdf → output is an existing dependency; output → output/pdf would be
// the cycle, which the external test package sidesteps).
package output_test
...
import (
	...
	pdf "github.com/nk-sentinel/cipherradar/cli/internal/output/pdf"
	"github.com/nk-sentinel/cipherradar/cli/internal/types"
)

// Blank import ensures pdf.init() fires, registering "pdf" with WriterFactory.
var _ = pdf.Writer{}
...
func TestPDFWriter_WriterFactory_Integration(t *testing.T) {
	w, err := output.WriterFactory("pdf")
	if err != nil {
