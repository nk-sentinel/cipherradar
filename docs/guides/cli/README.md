...
| [`algorithm-keysize-patterns.md`](algorithm-keysize-patterns.md) | How key sizes are declared per language/API, CipherRadar coverage, and detection gaps |
...
or the [completion](commands.md#cradar-completion) section of the command reference.
